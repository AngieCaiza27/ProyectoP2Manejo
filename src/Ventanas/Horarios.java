...
public class Horarios extends javax.swing.JPanel {
    ...
    public Horarios() {
        ...
        actualizarTabla("", (String) jComboCarreras.getSelectedItem());
        btnBuscar.addActionListener(e -> actualizarTabla(buscar.getText(), (String) jComboCarreras.getSelectedItem()));
        jComboCarreras.addActionListener(e -> actualizarTabla(buscar.getText(), (String) jComboCarreras.getSelectedItem()));
    ...
    private void jComboCarrerasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboCarrerasActionPerformed
       actualizarTabla(buscar.getText(), (String) jComboCarreras.getSelectedItem());
...
private void actualizarTabla(String buscar,String carrera) {
       crudHorarios.mostrarHorariosEnTabla(jTable1, buscar, carrera); // Llama al método para mostrar los horarios en la tabla.
    }
