...
public class CRUDLaboratorios {
    ...
    public void insertarLaboratorio(JTextField paraNombre, JTextField paraCapacidad, JTextField paraEdificio, JTextField paraTipo) {
    ...
    public void updateLaboratorio(JTextField paraId,JTextField paraNombre,JTextField paraCapacidad, JTextField paraEdificio, JTextField paraTipo ) {
