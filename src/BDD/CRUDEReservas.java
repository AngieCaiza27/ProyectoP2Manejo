...
public class CRUDEReservas {
    ...
    public List<CRUDEReservas> obtenerDatosDeLaBaseDeDatos(String buscar, String carrera, String nivel) {
        List<CRUDEReservas> horarios = new ArrayList<>();
        try {
            ...
            while (this.rs.next()) {
                CRUDEReservas horario = new CRUDEReservas();
    ...
    public void mostrarHorariosEnTabla(JTable tablaHorarios, String buscar, String carrera, String nivel) {
        List<CRUDEReservas> horarios = obtenerDatosDeLaBaseDeDatos(buscar, carrera, nivel);
        ...
        for (CRUDEReservas horario : horarios) {
...
public void llenarComboBoxEspacios(JComboBox<CRUDEReservas.Espacio> comboBox) {
    try {
...
public class Materia {
 ...
 public void llenarComboBoxMaterias(JComboBox<CRUDEReservas.Materia> comboBox) {
    try {
 ...
 public void llenarComboBoxResponsables(JComboBox<CRUDEReservas.Responsable> comboBox) {
    try {
